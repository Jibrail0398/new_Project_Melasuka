<?php 
    ...
    if (isset($_POST['tambah'])) {
        ...
        $medicine->add_medicine($kode_obat,$namaObat,$komposisi,$deskripsi,$kemasan,$dosis,$nama_standar_mims,$nomor_izin_edar,$harga,$stok,$gambar_obat,$id_produsen,$id_kategori,$id_golongan_obat,$cara_penyajian,$cara_penyimpanan);
    }
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" src="<?php echo $row['gambar_obat']; ?>" alt="Gambar Obat">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="small mb-1" for="kode_obat">Kode Obat</label>
                                <input class="form-control" id="kode_obat" name="kode_obat" type="text" placeholder="Masukan kode obat" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="namaObat">Nama Obat</label>
                                <input class="form-control" id="namaObat" name="nama_obat" type="text" placeholder="Masukan nama obat" required>
                            </div>
                            <div class="mb-3">
                            <?php
                            //kategori obat
                            ...
                            <input class="form-control" id="komposisi" name="komposisi" type="text" placeholder="Masukkan komposisi obat" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="deskripsi">Deskripsi</label>
                                <textarea class="form-control" id="deskripsi" name="deskripsi" type="text" placeholder="Masukkan deskripsi obat" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="kemasan">Kemasan</label>
                                <input class="form-control" id="kemasan" name="kemasan" type="text" placeholder="Masukkan kemasan obat" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="dosis">Dosis</label>
                                <input class="form-control" id="dosis" name="dosis" type="text" placeholder="Masukkan kemasan obat" required>
                            </div>
                            <div class="mb-3">
                            <?php
                            ...
                            <select name="id_penyajian_obat" class="form-control" required>
                            ...
                            <select name="id_cara_penyimpanan" class="form-control" required>
                            ...
                            <select name="id_produsen_obat" class="form-control" required>
                            ...
                            <select name="id_golongan_obat" class="form-control" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="MIMS" name="nama_standar_mims" type="text" placeholder="Masukan nama standar mims" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="IzinEdar">Nomor Izin Edar</label>
                                <input class="form-control" id="IzinEdar" name="nomor_izin_edar" type="text" placeholder="Masukan nomor izin edar" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="Harga">Harga</label>
                                <input class="form-control" id="Harga" name="harga" type="number" placeholder="Masukan harga jual" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="Stok">Stok</label>
                                <input class="form-control" id="Stok" name="stok" type="number" placeholder="Masukan stok obat" required>
                            </div>
                            <!-- Save changes button-->
