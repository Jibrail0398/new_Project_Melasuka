<?php 
    ...
    if (isset($_POST['simpan'])) {
        ...
        $query = "UPDATE `data_obat` SET `nama_obat` = '$namaObat', `komposisi` = '$komposisi', `deskripsi` = '$deskripsi', 
                ...
                `gambar_obat` = '$blob', `tanggal_diubah` = CURRENT_TIMESTAMP(), `id_produsen_obat` = $id_produsen, `id_kategori` = '$id_kategori', 
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <!-- <option value="<?= $row['id_kategori'] ?>" selected><?php echo $row['nama_kategori']; ?></option> -->
